...
当前: `versionCode = 25`, `versionName = "1.2.6"`
...
│  VideoPlayerActivity+Playback.kt — 播放控制逻辑
...
│       ├── ChapterDrawer.kt
│       ├── DanmakuDialogs.kt / DanmakuFilePickerDialog.kt
│       ├── SkipSettingsDrawer.kt
│       ├── SubtitleDialogs.kt / SubtitleFilePickerDialog.kt
│       └── VideoListDrawer.kt
│
├── navigation/                    — 导航
│   ├── AppNavGraph.kt
...
│   │   ├── PlayerScreen.kt  AboutScreen.kt
│   │   ├── BilibiliScreen.kt  LibraryScreen.kt
│   │   ├── FolderBrowserScreen.kt  VideoListScreen.kt
│   │   └── ... (更多)
│   ├── components/                — 11 个可复用组件
│   │   ├── UpdateDialog.kt  Cards.kt  Dialogs.kt
│   │   ├── ImmersiveTopAppBar.kt  PreferenceItems.kt
│   │   └── ...
│   ├── player/                    — 播放器控件 (7 文件)
